...
var AttesterRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
...
var ProposerRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
...
var AggregatorRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
...
var SyncCommitteeRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
...
var SyncCommitteeContributionRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
...
var UnknownDutyTypeRunner = func(keySet *spectestingutils.TestKeySet) runner2.Runner {
	return baseRunner(spectestingutils.UnknownDutyType, spectestingutils.UnknownDutyValueCheck(), keySet)
}

var baseRunner = func(role spectypes.BeaconRole, valCheck specqbft.ProposedValueCheckF, keySet *spectestingutils.TestKeySet) runner2.Runner {
	...
	case spectypes.BNRoleAttester:
		return runner2.NewAttesterRunnner(
	...
	case spectypes.BNRoleAggregator:
		return runner2.NewAggregatorRunner(
			spectypes.NowTestNetwork,
			share,
			contr,
			spectestingutils.NewTestingBeaconNode(),
	...
	case spectypes.BNRoleProposer:
		return runner2.NewProposerRunner(
			spectypes.NowTestNetwork,
			share,
			contr,
			spectestingutils.NewTestingBeaconNode(),
	...
	case spectypes.BNRoleSyncCommittee:
		return runner2.NewSyncCommitteeRunner(
			spectypes.NowTestNetwork,
			share,
			contr,
			spectestingutils.NewTestingBeaconNode(),
	...
	case spectypes.BNRoleSyncCommitteeContribution:
		return runner2.NewSyncCommitteeAggregatorRunner(
			spectypes.NowTestNetwork,
			share,
			contr,
			spectestingutils.NewTestingBeaconNode(),
	...
	case spectestingutils.UnknownDutyType:
		ret := runner2.NewAttesterRunnner(
			spectypes.NowTestNetwork,
			share,
			contr,
			spectestingutils.NewTestingBeaconNode(),
		...
		ret.(*runner2.AttesterRunner).BaseRunner.BeaconRoleType = spectestingutils.UnknownDutyType
		return ret
	default:
