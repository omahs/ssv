...
// 	WaitAndPop(priority MessagePrioritizer) (*DecodedSSVMessage, <-chan *DecodedSSVMessage)
// }
...
// func (q *PriorityQueue) WaitAndPop(priority MessagePrioritizer) (*DecodedSSVMessage, <-chan *DecodedSSVMessage) {
// 	q.waitingLock.Lock()
...
type Queue interface {
	...
	// Pop removes & returns the highest priority message.
	// Returns nil if no message is found.
	Pop(MessagePrioritizer) *DecodedSSVMessage
	...
	WaitAndPop(MessagePrioritizer) (*DecodedSSVMessage, <-chan *DecodedSSVMessage)
}
