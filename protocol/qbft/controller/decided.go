...
import (
	...
	instance2 "github.com/bloxapp/ssv/protocol/qbft/instance"
...
func (c *Controller) UponDecided(msg *specqbft.SignedMessage) (*specqbft.SignedMessage, error) {
	...
	if inst == nil {
		i := instance2.NewInstance(c.GetConfig(), c.Share, c.Identifier, msg.Message.Height)
...
func validateDecided(
	...
	if err := instance2.BaseCommitValidation(config, signedDecided, signedDecided.Message.Height, share.Committee); err != nil {
		return errors.Wrap(err, "invalid decided msg")
	}
